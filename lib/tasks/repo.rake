...
# Taken from https://github.com/tootsuite/mastodon/blob/main/lib/tasks/repo.rake
# tootsuite/mastodon is licensed under the AGPL.
...
namespace :repo do
  ...
  task :authors do
    ...
    url = 'https://api.github.com/repos/bridges-anime/bridges/contributors?anon=1'
